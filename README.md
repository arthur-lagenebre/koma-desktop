...
looking at it, as every field of every window says what it is for. The
landmarks of §9.3 are listed in the order their pages come, whatever order a
document puts them in, since §9.3 fixes none and a back cover above the start
of the story is a list nobody would follow. The window opens the size it was
left, and full screen if it was left full screen.
