...
ComicInfo travels with the packages; it converts archives beside themselves,
...
direction, series, and what the publication says about reading it — how it is
taken in, what it may do to a reader, a sentence for someone deciding whether
they can read it — writing only what changed. Pages lists the pages of the
publication and changes what the package says about one — its role, its span,
its side of the spread, the chapter it opens, the number printed on it, what a
